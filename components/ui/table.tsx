...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn("bg-secondary/50 border-t border-border font-medium [&>tr]:last:border-b-0", className)}
      {...props}
    />
  );
}
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-secondary/40 data-[state=selected]:bg-secondary border-b border-border transition-colors",
        className
      )}
      {...props}
    />
